...
1. Spiderman (just sample)  [Link to Repo](https://www.youtube.com)

--- 
## How to contribute in this open source Project

First, please understand that this is not your regular project to merge your PR. This repo requires you to finish all assignments that are in controller folder. We don't accept half work, please finish all controllers and then reach us out on [Discord](https://hitesh.ai/discord) or [Twitter](https://twitter.com/deepanshu_2910) and after checking your repo, I will add link to your repo in this readme.